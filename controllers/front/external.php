...
class genomeexternalModuleFrontController extends ModuleFrontController
{
    /**
    ...
    public function postProcess()
    {
        ...
        $this->module->validateOrder(
                    (int) $cart->id, 
                    Configuration::get('PS_OS_GENOME_OPEN'), 
        ...
        try {
            $this->postRedirect('https://hpp-service.genome.eu/hpp', $params);
        } catch (Exception $e) {
            if (isset($order)) {
