...
class GenomePaymentReturnModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('module:genome/views/templates/front/payment_return.tpl');
    }
